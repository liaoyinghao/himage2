...
class SaeTOAuthV2{
	...
	//直接返回的是微博开放式授权的URL 也是请求微博登录页面的URL
	/**
	 * construct WeiboOAuth object
	 */
	function __construct($client_id, $client_secret, $access_token = NULL, $refresh_token = NULL) {
		//$client_id--申请微博登录时候产生的App Key
		//$client_secret--申请微博登录时候产生的App Secret
		//因为$access_token 和 $refresh_token的值一开始获取不到 所以在实例化类的时候 只需要传入$client_id和$client_secret
