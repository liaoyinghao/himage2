...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title> 照片上传系统 - 照片上传页面 </title>
        <link rel="stylesheet" href="/Public/statics/webuploader-0.1.5/xb-webuploader.css">
<script src="/Public/statics/js/jquery-1.10.2.min.js"></script>
    </head>
    	<center>
			 <form action="<?php echo U('Backstage/Index/action',array('i'=>$i));?>" method="post">
			 	<div id="upload-5901c31794eeb" class="xb-uploader">
    <div class="queueList">
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-5901c31794eeb .filePicker",
            label: '点击选择文件',
            multiple : true
        },
        dnd: "#upload-5901c31794eeb .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
        ...
        chunked: true,
        server: "<?php echo U('Backstage/Index/ajax_upload');?>",
        //最多选择多少图片
        fileNumLimit: 300,
        //最大单次允许上传的容量
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-5901c31794eeb .filePicker2",
       label: '继续添加'
    });
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-5901c31794eeb .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-5901c31794eeb .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-5901c31794eeb .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
