...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title><?php echo ($onzero['item_name']); ?>-<?php echo ($onzero['title_count']); ?>-图片上传</title>
         <link rel="stylesheet" href="/Public/statics/webuploader-0.1.5/xb-webuploader.css">
<script src="/Public/statics/js/jquery-1.10.2.min.js"></script>
    </head>
    	<center>
    	        <font color="red">"<?php echo ($onzero['item_name']); ?>"项目&nbsp;"<?php echo ($onzero['title_count']); ?>"导航&nbsp;图片上传</font>
                <br><br><br><br><br>
    	        <form action="<?php echo U('Admin/Item/action',array('img_tid'=>$onzero['title_id'],'img_iid'=>$onzero['item_id']));?>" method="post">
			 	<div id="upload-59097895cd68c" class="xb-uploader">
    <div class="queueList">
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        pick: {
            id: "#upload-59097895cd68c .filePicker",
            label: '点击选择文件',
            multiple : true
        },
        dnd: "#upload-59097895cd68c .queueList",
        paste: document.body,
        // accept: {
        //     title: 'Images',
        ...
        chunked: true,
        server: "<?php echo U('Admin/Item/ajax_upload');?>",
        //最多选择多少图片
        fileNumLimit: 300,
        //最大单次允许上传的容量
    ...
    // 添加“添加文件”的按钮，
    uploader.addButton({
       id: "#upload-59097895cd68c .filePicker2",
       label: '继续添加'
    });
    ...
    function updateStatus() {
        ...
        if ( state === 'ready' ) {
            ...
            if (fileCount==stats.successNum && stats.successNum!=0) {
                $('#upload-59097895cd68c .webuploader-element-invisible').remove();
            }
        }
    ...
    function setState( val ) {
        ...
        switch ( state ) {
            ...
            case 'ready':
                ...
                $( "#upload-59097895cd68c .filePicker2" ).removeClass( 'element-invisible');
            ...
            case 'uploading':
                $( "#upload-59097895cd68c .filePicker2" ).addClass( 'element-invisible' );
                $progress.show();
                $upload.text( '暂停上传' );
                break;
