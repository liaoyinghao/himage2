...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/himage2/Public/home/css/swiper.min.css"/>
	<link rel="stylesheet" type="text/css" href="/himage2/Public/home/css/index.css"/>
...
<body>
	<div id="load" style="#000;">
		<img src="/himage2/Public/home/images/load/load.gif"/>
	</div>
	<div id="wrap-box">
		<div id="box">
			<div id="banner">
				...
				<span style="display: block;" id="pin">拼图</span><span style="display: none;" id="qu">取消拼图</span>
			</div>
			...
			<ul>
				...
				<li class="color">
					<a href="#" class="btn font" data-toggle="modal" data-target="#myModal" style="padding: 0;outline: none;">
						&#xe639;
					</a>
				</li>
				<li class="sort color">
					<a href="<?php echo ($dz); ?>">&#xe602;</a>
				</li>
				<li class="color">
	...
	<!-- 图片详情 -->
		...
		<div id="sort-show">
			<p class="btn" style="background:url(/himage2/Public/home/images/icon/x.png) no-repeat center;font-size: 0.6rem;"></p>
			<div class="swiper-container">
		        		<div class="swiper-wrapper">
		        		</div>
		    	</div>
	...
	<script src="/himage2/Public/home/js/lazy.min.js" type="text/javascript" charset="utf-8"></script>
	<script src="/himage2/Public/home/js/swiper.min.js" type="text/javascript" charset="utf-8"></script>
	<script src="/himage2/Public/home/js/index.js" type="text/javascript" charset="utf-8"></script>
	<script src="/himage2/Public/home/js/jweixin-1.0.0.js"></script>
	<script src="/himage2/Public/home/js/zepto.min.js"></script>
...
wx.config({
  ...
  wx.ready(function () {
     wx.onMenuShareTimeline({
                title: '<?php echo ($we_title); ?>', 
                link: '<?php echo ($we_link); ?>', 
                imgUrl: '<?php echo ($we_imgUrl); ?>', 
                success: function() {
                },
                cancel: function() {
                }
		...
		// 获取所有图片
			$.ajax({
				...
				success : function(data){
					...
					for( i=0;i<oData.length;i++ ){
						str+="<div class='box' style=' position: relative;'><div class='wrap-img' style='background: url("+oData[i].img_add+") center no-repeat;  background-size: cover;'></div><input type='checkbox'/></div>"	
						str1+="<div class='swiper-slide'><img class='cc' src='"+oData[i].img_add+"'/><div class='heart'>&#xe60a;<span class='heart-num'>"+oData[i].img_z+"</span></div></div>";
						zanUrl .push(oData[i].img_add);
						// console.log($("swiper-slide img"))
					}
